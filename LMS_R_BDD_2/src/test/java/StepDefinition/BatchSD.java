...
@Given("User creates New User {string} from {string} sheet for the LMS API From Excel")
public void user_creates_new_user_from_sheet_for_the_lms_api_from_excel(String feature, String sheetName) throws IOException {
...
@Given("User creates request for {string} from {string} sheet for the LMS API From Excel")
public void user_creates_request_for_from_sheet_for_the_lms_api_from_excel(String feature, String sheetName) throws IOException {
...
@Given("User creates request get by batchId {string} from {string} sheet for the LMS API From Excel")
...
@Given("User creates request get by BatchName {string} from {string} sheet for the LMS API From Excel")
public void user_creates_request_get_by_batch_name_from_sheet_for_the_lms_api_from_excel(String feature, String sheetName) throws IOException {
